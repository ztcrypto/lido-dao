...
contract('Lido: deposit loop iteration limit', (addresses) => {
  ...
  it('a user submits 20 * 32 ETH', async () => {
    ...
    assertBn(await pool.getTotalControlledEther(), ETH(20 * 32), 'total controlled ether')
  ...
  it('a user submits 2 * 32 ETH', async () => {
    ...
    assertBn(await pool.getTotalControlledEther(), ETH(22 * 32), 'total controlled ether')
  ...
  it('the number of assigned validators is still limited by the number of available validator keys', async () => {
    ...
    const ether2Stat = await pool.getEther2Stat()
    assertBn(ether2Stat.deposited, ETH(21 * 32), 'deposited ether2')
